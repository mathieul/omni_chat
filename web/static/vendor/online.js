...
var _user$project$Online_App$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Online.elm')
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('lead')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], 'latestMessage = ', model.latestMessage))
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('TODO: implement in Elm now 🤓!')
					]))
			]));
};
var _user$project$Online_App$socketServer = 'ws://localhost:4000/socket/websocket';
var _user$project$Online_App$Model = F2(
	function (a, b) {
		return {socket: a, latestMessage: b};
	});
var _user$project$Online_App$ChatMessage = F2(
	function (a, b) {
		return {user: a, body: b};
	});
var _user$project$Online_App$chatMessageDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Online_App$ChatMessage,
...
var _user$project$Online_App$ReceiveChatMessage = function (a) {
	return {ctor: 'ReceiveChatMessage', _0: a};
};
var _user$project$Online_App$initSocket = A4(
	_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
	'welcome',
	'subject:lobby',
	_user$project$Online_App$ReceiveChatMessage,
	_fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug(
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$init(_user$project$Online_App$socketServer)));
var _user$project$Online_App$initialModel = {socket: _user$project$Online_App$initSocket, latestMessage: ''};
var _user$project$Online_App$PhoenixMsg = function (a) {
	return {ctor: 'PhoenixMsg', _0: a};
};
var _user$project$Online_App$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NoOp':
			...
			case 'PhoenixMsg':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{socket: phxSocket}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Online_App$PhoenixMsg, phxCmd)
				};
			default:
				var _p2 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Online_App$chatMessageDecoder, _p0._0);
				if (_p2.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{latestMessage: _p2._0.body}),
...
var _user$project$Online_App$subscriptions = function (model) {
	return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.socket, _user$project$Online_App$PhoenixMsg);
};
var _user$project$Online_App$NoOp = {ctor: 'NoOp'};

var _user$project$Online$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$Online_App$initialModel, _1: _elm_lang$core$Platform_Cmd$none},
			update: _user$project$Online_App$update,
			subscriptions: _user$project$Online_App$subscriptions,
			view: _user$project$Online_App$view
		})
};
