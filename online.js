...
var _folkertdev$elm_state$State$run = F2(
	function (initialState, _p0) {
		var _p1 = _p0;
		return _p1._0(initialState);
	});
var _folkertdev$elm_state$State$finalValue = function (initialState) {
	return function (_p2) {
		return _elm_lang$core$Basics$fst(
			A2(_folkertdev$elm_state$State$run, initialState, _p2));
	};
};
var _folkertdev$elm_state$State$finalState = function (initialState) {
	return function (_p3) {
		return _elm_lang$core$Basics$snd(
			A2(_folkertdev$elm_state$State$run, initialState, _p3));
	};
};
...
var _folkertdev$elm_state$State$map = F2(
	function (f, _p4) {
		...
		return _folkertdev$elm_state$State$State(helper);
	});
var _folkertdev$elm_state$State$map2 = F3(
	function (f, _p8, _p7) {
		...
		var helper = function (value) {
			var _p11 = _p9._0(value);
			var value1 = _p11._0;
			var newStep = _p11._1;
			var _p12 = _p10._0(newStep);
			var value2 = _p12._0;
			var newerStep = _p12._1;
			return {
				ctor: '_Tuple2',
...
var _folkertdev$elm_state$State$andMap = _folkertdev$elm_state$State$map2(
	F2(
		function (x, y) {
			return x(y);
		}));
...
var _folkertdev$elm_state$State$traverse = F2(
	function (f, list) {
		var folder = F2(
			function (elem, accum) {
				return A3(
		...
		return A3(
			_elm_lang$core$List$foldr,
			folder,
			_folkertdev$elm_state$State$state(
				_elm_lang$core$Native_List.fromArray(
					[])),
			list);
	});
var _folkertdev$elm_state$State$combine = _folkertdev$elm_state$State$traverse(_elm_lang$core$Basics$identity);
var _folkertdev$elm_state$State$filterM = F2(
	function (predicate, list) {
		var combine = F3(
			function (x, keep, ys) {
				return keep ? A2(_elm_lang$core$List_ops['::'], x, ys) : ys;
			});
		var folder = F2(
			function (x, accum) {
				return A3(
...
var _folkertdev$elm_state$State$andThen = F2(
	function (_p13, f) {
		var _p14 = _p13;
		var operation = function (s) {
			var _p15 = _p14._0(s);
			var a = _p15._0;
			var newState = _p15._1;
			var _p16 = f(a);
			var g = _p16._0;
			return g(newState);
		};
		return _folkertdev$elm_state$State$State(operation);
	});
var _folkertdev$elm_state$State$join = function (value) {
	return A2(_folkertdev$elm_state$State$andThen, value, _elm_lang$core$Basics$identity);
};
var _folkertdev$elm_state$State$foldlM = F3(
	function (f, initialValue, list) {
		var f$ = F3(
			function (x, k, z) {
				return A2(
		...
		return A4(_elm_lang$core$List$foldr, f$, _folkertdev$elm_state$State$state, list, initialValue);
	});
...
var _folkertdev$elm_state$State$advance = function (f) {
	var helper = function (x) {
		...
		return A2(
			...
			_folkertdev$elm_state$State$put(newState));
	};
...
var _folkertdev$elm_state$State$modify = function (f) {
	return A2(
		_folkertdev$elm_state$State$andThen,
		_folkertdev$elm_state$State$get,
		function (x) {
			return _folkertdev$elm_state$State$put(
				f(x));
		});
};
...
var _folkertdev$outmessage$OutMessage$mapCmd = F2(
	function (f, _p8) {
		...
		return {
			ctor: '_Tuple3',
			_0: _p9._0,
			_1: A2(_elm_lang$core$Platform_Cmd$map, f, _p9._1),
			_2: _p9._2
		};
	});
	...
	function ($default, f) {
		return function (_p10) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				$default,
				A2(_elm_lang$core$Maybe$map, f, _p10));
		};
	});
var _folkertdev$outmessage$OutMessage$swap = function (_p11) {
	var _p12 = _p11;
	return {ctor: '_Tuple2', _0: _p12._1, _1: _p12._0};
};
...
var _folkertdev$outmessage$OutMessage$evaluate = F2(
	function (interpretOutMsg, _p15) {
		var _p16 = _p15;
		return A3(
			_folkertdev$outmessage$OutMessage$run,
			_p16._1,
			_p16._0,
			A2(_folkertdev$outmessage$OutMessage$wrap, interpretOutMsg, _p16._2));
	});
var _folkertdev$outmessage$OutMessage$evaluateMaybe = F3(
	function (interpretOutMsg, $default, _p17) {
		var _p18 = _p17;
		return A3(
			_folkertdev$outmessage$OutMessage$run,
			_p18._1,
...
var _folkertdev$outmessage$OutMessage$evaluateResult = F3(
	function (interpretOutMsg, onErr, _p19) {
		var _p20 = _p19;
		var stateful = function () {
			var _p21 = _p20._2;
			if (_p21.ctor === 'Ok') {
				return A2(_folkertdev$outmessage$OutMessage$wrap, interpretOutMsg, _p21._0);
			} else {
				return _folkertdev$elm_state$State$state(
					onErr(_p21._0));
			}
		}();
		return A3(_folkertdev$outmessage$OutMessage$run, _p20._1, _p20._0, stateful);
	});
var _folkertdev$outmessage$OutMessage$evaluateList = F2(
	function (interpretOutMsg, _p22) {
		var _p23 = _p22;
		return A3(
			_folkertdev$outmessage$OutMessage$run,
			_p23._1,
...
var _user$project$Components_DiscussionEditor$initialModel = {editing: false, subject: ''};
var _user$project$Components_DiscussionEditor$Model = F2(
	function (a, b) {
		return {editing: a, subject: b};
	});
var _user$project$Components_DiscussionEditor$CreateDiscussion = function (a) {
	return {ctor: 'CreateDiscussion', _0: a};
};
var _user$project$Components_DiscussionEditor$UpdateSubject = function (a) {
	return {ctor: 'UpdateSubject', _0: a};
};
var _user$project$Components_DiscussionEditor$StopEditing = {ctor: 'StopEditing'};
var _user$project$Components_DiscussionEditor$formView = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('card-block text-xs-center')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_user$project$Components_DiscussionEditor$CreateDiscussion(model.subject))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$html$Html_Attributes$class('form-control card-title'),
												_elm_lang$html$Html_Attributes$placeholder('Enter subject...'),
												_elm_lang$html$Html_Attributes$required(true),
												_elm_lang$html$Html_Attributes$autofocus(true),
												_elm_lang$html$Html_Events$onInput(_user$project$Components_DiscussionEditor$UpdateSubject)
											]),
										_elm_lang$core$Native_List.fromArray(
											[]))
									])),
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$html$Html_Attributes$class('btn btn-lg btn-primary btn-block col-xs-5')
													]),
												_elm_lang$core$Native_List.fromArray(
													[
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$html$Html_Attributes$class('btn btn-lg btn-secondary btn-block col-xs-5 offset-xs-1'),
														_elm_lang$html$Html_Events$onClick(_user$project$Components_DiscussionEditor$StopEditing)
													]),
												_elm_lang$core$Native_List.fromArray(
													[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('card-footer text-muted')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('start new discussion')
					]))
			]));
};
var _user$project$Components_DiscussionEditor$StartEditing = {ctor: 'StartEditing'};
var _user$project$Components_DiscussionEditor$choiceView = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('card card-inverse card-warning')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
								...
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													{ctor: '_Tuple2', _0: 'margin-top', _1: '1.5rem'}
												]))
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('New Discussion')
										]))
								])),
							A2(
							_elm_lang$html$Html$div,
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$type$('button'),
											_elm_lang$html$Html_Attributes$class('btn btn-lg btn-primary m-y-1'),
											_elm_lang$html$Html_Events$onClick(_user$project$Components_DiscussionEditor$StartEditing)
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											A2(
...
var _user$project$Components_DiscussionEditor$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				model.editing ? _user$project$Components_DiscussionEditor$formView(model) : _user$project$Components_DiscussionEditor$choiceView
			]));
};
var _user$project$Components_DiscussionEditor$DiscussionCreationRequested = function (a) {
	return {ctor: 'DiscussionCreationRequested', _0: a};
};
var _user$project$Components_DiscussionEditor$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'StartEditing':
			...
			default:
				var _p1 = _p0._0;
				var cleanSubject = _elm_community$string_extra$String_Extra$humanize(
					_elm_lang$core$String$toLower(
						_elm_lang$core$String$trim(_p1)));
				return _elm_lang$core$String$isEmpty(cleanSubject) ? {ctor: '_Tuple3', _0: model, _1: _elm_lang$core$Platform_Cmd$none, _2: _elm_lang$core$Maybe$Nothing} : {
					ctor: '_Tuple3',
					_0: _elm_lang$core$Native_Utils.update(
						model,
					...
					_2: _elm_lang$core$Maybe$Just(
						_user$project$Components_DiscussionEditor$DiscussionCreationRequested(_p1))
				};
		}
	});

var _user$project$Online_Types$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {socket: a, connected: b, presences: c, discussions: d, discussionId: e, messages: f, config: g, route: h, discussionEditorModel: i, currentMessage: j};
									};
								};
							};
						};
...
var _user$project$Online_Types$AppConfig = F5(
	function (a, b, c, d, e) {
		return {chatterId: a, nickname: b, maxMessages: c, discussionId: d, socketServer: e};
	});
var _user$project$Online_Types$PresenceStateMetaWrapper = function (a) {
	return {metas: a};
};
var _user$project$Online_Types$PresenceStateMetaValue = F3(
	function (a, b, c) {
		return {phx_ref: a, online_at: b, nickname: c};
	});
var _user$project$Online_Types$Discussion = F4(
	function (a, b, c, d) {
		return {id: a, subject: b, participants: c, last_activity: d};
	});
var _user$project$Online_Types$Chatter = F2(
	function (a, b) {
		return {id: a, nickname: b};
	});
var _user$project$Online_Types$DiscussionMessage = F2(
	function (a, b) {
		return {chatter: a, content: b};
	});
var _user$project$Online_Types$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _user$project$Online_Types$DiscussionRoute = function (a) {
	return {ctor: 'DiscussionRoute', _0: a};
};
var _user$project$Online_Types$DiscussionListRoute = {ctor: 'DiscussionListRoute'};
var _user$project$Online_Types$ShowDiscussion = function (a) {
	return {ctor: 'ShowDiscussion', _0: a};
};
var _user$project$Online_Types$ShowDiscussionList = {ctor: 'ShowDiscussionList'};
var _user$project$Online_Types$DiscussionEditorMsg = function (a) {
	return {ctor: 'DiscussionEditorMsg', _0: a};
};
var _user$project$Online_Types$SendMessage = {ctor: 'SendMessage'};
var _user$project$Online_Types$UpdateCurrentMessage = function (a) {
	return {ctor: 'UpdateCurrentMessage', _0: a};
};
var _user$project$Online_Types$ReceiveMessage = function (a) {
	return {ctor: 'ReceiveMessage', _0: a};
};
var _user$project$Online_Types$ReceiveMessageList = function (a) {
	return {ctor: 'ReceiveMessageList', _0: a};
};
var _user$project$Online_Types$ReceiveAllDiscussions = function (a) {
	return {ctor: 'ReceiveAllDiscussions', _0: a};
};
var _user$project$Online_Types$DidLeaveChannel = {ctor: 'DidLeaveChannel'};
var _user$project$Online_Types$DidJoinChannel = {ctor: 'DidJoinChannel'};
var _user$project$Online_Types$HandlePresenceDiff = function (a) {
	return {ctor: 'HandlePresenceDiff', _0: a};
};
var _user$project$Online_Types$HandlePresenceState = function (a) {
	return {ctor: 'HandlePresenceState', _0: a};
};
var _user$project$Online_Types$PhoenixMsg = function (a) {
	return {ctor: 'PhoenixMsg', _0: a};
};
var _user$project$Online_Types$InitApplication = {ctor: 'InitApplication'};
var _user$project$Online_Types$NoOp = {ctor: 'NoOp'};

var _user$project$Online_Routing$routeFromResult = function (result) {
	var _p0 = result;
	if (_p0.ctor === 'Ok') {
		return _p0._0;
	} else {
		return _user$project$Online_Types$NotFoundRoute;
	}
};
var _user$project$Online_Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			_evancz$url_parser$UrlParser$format,
			_user$project$Online_Types$DiscussionListRoute,
			_evancz$url_parser$UrlParser$s('')),
			A2(
			_evancz$url_parser$UrlParser$format,
			_user$project$Online_Types$DiscussionRoute,
			A2(
				_evancz$url_parser$UrlParser_ops['</>'],
				_evancz$url_parser$UrlParser$s('discussions'),
...
var _user$project$Online_Routing$hashParser = function (location) {
	return A3(
		_evancz$url_parser$UrlParser$parse,
		_elm_lang$core$Basics$identity,
		_user$project$Online_Routing$matchers,
		A2(_elm_lang$core$String$dropLeft, 1, location.hash));
};
var _user$project$Online_Routing$parser = _elm_lang$navigation$Navigation$makeParser(_user$project$Online_Routing$hashParser);

var _user$project$Online_Backend$userParams = function (config) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'chatter_id',
				_1: _elm_lang$core$Json_Encode$int(config.chatterId)
			},
				{
				ctor: '_Tuple2',
				_0: 'nickname',
				_1: _elm_lang$core$Json_Encode$string(config.nickname)
			}
			]));
};
var _user$project$Online_Backend$doHandlePhoenixMsg = F2(
	function (phxMsg, model) {
		var _p0 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$update, phxMsg, model.socket);
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{socket: phxSocket}),
			_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Online_Types$PhoenixMsg, phxCmd)
		};
	});
var _user$project$Online_Backend$discussionChannel = function (discussionId) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'discussion:',
		_elm_lang$core$Basics$toString(discussionId));
};
var _user$project$Online_Backend$leaveDiscussionChannel = F2(
	function (discussionId, socket) {
		var channelName = _user$project$Online_Backend$discussionChannel(discussionId);
		var unsubscribedSocket = A3(_fbonetti$elm_phoenix_socket$Phoenix_Socket$off, 'messages', channelName, socket);
		return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$leave, channelName, unsubscribedSocket);
	});
var _user$project$Online_Backend$doJoinDiscussionChannel = F3(
	function (discussionId, config, socket) {
		var channelName = _user$project$Online_Backend$discussionChannel(discussionId);
		var subscribedSocket = A4(
			_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
			'message',
			channelName,
			_user$project$Online_Types$ReceiveMessage,
			A4(_fbonetti$elm_phoenix_socket$Phoenix_Socket$on, 'messages', channelName, _user$project$Online_Types$ReceiveMessageList, socket));
		var channel = A2(
			_fbonetti$elm_phoenix_socket$Phoenix_Channel$withPayload,
			_user$project$Online_Backend$userParams(config),
			_fbonetti$elm_phoenix_socket$Phoenix_Channel$init(channelName));
		return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$join, channel, subscribedSocket);
	});
var _user$project$Online_Backend$doSendMessage = F3(
	function (content, discussionId, socket) {
		...
		var phxPush = A2(
			...
			payload,
			A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init, 'send_message', channelName));
		return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, phxPush, socket);
	});
var _user$project$Online_Backend$hallChannel = 'discussion:hall';
var _user$project$Online_Backend$initSocket = function (socketServer) {
	return A4(
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
		'all_discussions',
		_user$project$Online_Backend$hallChannel,
		_user$project$Online_Types$ReceiveAllDiscussions,
		A4(
			_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
			'presence_diff',
			_user$project$Online_Backend$hallChannel,
			_user$project$Online_Types$HandlePresenceDiff,
			A4(
				_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
				'presence_state',
				_user$project$Online_Backend$hallChannel,
				_user$project$Online_Types$HandlePresenceState,
				_fbonetti$elm_phoenix_socket$Phoenix_Socket$init(socketServer))));
};
var _user$project$Online_Backend$doCreateDiscussion = F2(
	function (subject, socket) {
		var payload = _elm_lang$core$Json_Encode$object(
			_elm_lang$core$Native_List.fromArray(
				[
					{
					ctor: '_Tuple2',
					_0: 'subject',
					_1: _elm_lang$core$Json_Encode$string(subject)
				}
				]));
		var phxPush = A2(
			_fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload,
			payload,
			A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init, 'create_discussion', _user$project$Online_Backend$hallChannel));
		return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, phxPush, socket);
	});
var _user$project$Online_Backend$doJoinDiscussionHallChannel = F2(
	function (config, socket) {
		var channel = A2(
			_fbonetti$elm_phoenix_socket$Phoenix_Channel$onClose,
			_elm_lang$core$Basics$always(_user$project$Online_Types$DidLeaveChannel),
			A2(
				_fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoin,
				_elm_lang$core$Basics$always(_user$project$Online_Types$DidJoinChannel),
				A2(
					_fbonetti$elm_phoenix_socket$Phoenix_Channel$withPayload,
					_user$project$Online_Backend$userParams(config),
					_fbonetti$elm_phoenix_socket$Phoenix_Channel$init(_user$project$Online_Backend$hallChannel))));
		return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$join, channel, socket);
	});

var _user$project$Online_Model$initialAppConfig = function (rawConfig) {
	return {
		chatterId: A2(
			_elm_lang$core$Result$withDefault,
			0,
			_elm_lang$core$String$toInt(rawConfig.chatter_id)),
		nickname: rawConfig.nickname,
		maxMessages: A2(
			_elm_lang$core$Result$withDefault,
			1,
			_elm_lang$core$String$toInt(rawConfig.max_messages)),
		discussionId: _elm_lang$core$Result$toMaybe(
			_elm_lang$core$String$toInt(rawConfig.maybe_discussion_id)),
		socketServer: rawConfig.socket_server
	};
};
var _user$project$Online_Model$initialModel = F2(
	function (rawConfig, route) {
		return {
			socket: _user$project$Online_Backend$initSocket(rawConfig.socket_server),
			connected: false,
			presences: _elm_lang$core$Dict$empty,
			discussions: _elm_lang$core$Native_List.fromArray(
				[]),
			discussionId: _elm_lang$core$Maybe$Nothing,
			messages: _elm_lang$core$Native_List.fromArray(
				[]),
			config: _user$project$Online_Model$initialAppConfig(rawConfig),
			route: route,
			discussionEditorModel: _user$project$Components_DiscussionEditor$initialModel,
			currentMessage: ''
		};
	});
var _user$project$Online_Model$init = F2(
	function (rawConfig, result) {
		var currentRoute = _user$project$Online_Routing$routeFromResult(result);
		return {
			ctor: '_Tuple2',
			_0: A2(_user$project$Online_Model$initialModel, rawConfig, currentRoute),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$Online_Model$ConfigFromJs = F5(
	function (a, b, c, d, e) {
		return {chatter_id: a, nickname: b, max_messages: c, maybe_discussion_id: d, socket_server: e};
	});

var _user$project$Online_Presence$presenceStateMetaDecoder = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Online_Types$PresenceStateMetaValue,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'phx_ref', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'online_at', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'nickname', _elm_lang$core$Json_Decode$string));
var _user$project$Online_Presence$presenceStateMetaWrapperDecoder = A2(
	_elm_lang$core$Json_Decode$object1,
	_user$project$Online_Types$PresenceStateMetaWrapper,
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'metas',
		_elm_lang$core$Json_Decode$list(_user$project$Online_Presence$presenceStateMetaDecoder)));
var _user$project$Online_Presence$presenceStateDecoder = _elm_lang$core$Json_Decode$dict(_user$project$Online_Presence$presenceStateMetaWrapperDecoder);
var _user$project$Online_Presence$processPresenceState = F2(
	function (raw, model) {
		var _p0 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Online_Presence$presenceStateDecoder, raw);
		if (_p0.ctor === 'Ok') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{presences: _p0._0});
...
var _user$project$Online_Presence$PresenceDiff = F2(
	function (a, b) {
		return {leaves: a, joins: b};
	});
var _user$project$Online_Presence$presenceDiffDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Online_Presence$PresenceDiff,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'leaves', _user$project$Online_Presence$presenceStateDecoder),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'joins', _user$project$Online_Presence$presenceStateDecoder));
var _user$project$Online_Presence$processPresenceDiff = F2(
	function (raw, model) {
		var _p1 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Online_Presence$presenceDiffDecoder, raw);
		if (_p1.ctor === 'Ok') {
			var _p3 = _p1._0;
			var insertPresence = F2(
				function (id, presences) {
					var _p2 = A2(_elm_lang$core$Dict$get, id, _p3.joins);
					if (_p2.ctor === 'Just') {
						return A3(_elm_lang$core$Dict$insert, id, _p2._0, presences);
					} else {
						return presences;
					}
				});
			var presencesAfterDel = A3(
				_elm_lang$core$List$foldl,
				_elm_lang$core$Dict$remove,
				model.presences,
				_elm_lang$core$Dict$keys(_p3.leaves));
			var presencesAfterAdd = A3(
				_elm_lang$core$List$foldl,
				insertPresence,
				presencesAfterDel,
				_elm_lang$core$Dict$keys(_p3.joins));
			return _elm_lang$core$Native_Utils.update(
				model,
				{presences: presencesAfterAdd});
		} else {
			return model;
		}
	});

var _user$project$Online_Discussion$participantDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Online_Types$Chatter,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'nickname', _elm_lang$core$Json_Decode$string));
var _user$project$Online_Discussion$discussionDecoder = A5(
	_elm_lang$core$Json_Decode$object4,
	_user$project$Online_Types$Discussion,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'subject', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'participants',
		_elm_lang$core$Json_Decode$list(_user$project$Online_Discussion$participantDecoder)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'last-activity', _elm_lang$core$Json_Decode$string));
var _user$project$Online_Discussion$JsonApiContainer = function (a) {
	return {data: a};
};
var _user$project$Online_Discussion$AllDiscussionsWrapper = function (a) {
	return {attributes: a};
};
var _user$project$Online_Discussion$attributesDecoder = A2(
	_elm_lang$core$Json_Decode$object1,
	_user$project$Online_Discussion$AllDiscussionsWrapper,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'attributes', _user$project$Online_Discussion$discussionDecoder));
var _user$project$Online_Discussion$collectionDecoder = A2(
	_elm_lang$core$Json_Decode$object1,
	_user$project$Online_Discussion$JsonApiContainer,
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'data',
		_elm_lang$core$Json_Decode$list(_user$project$Online_Discussion$attributesDecoder)));
var _user$project$Online_Discussion$receiveAll = F2(
	function (raw, model) {
		var _p0 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Online_Discussion$collectionDecoder, raw);
		if (_p0.ctor === 'Ok') {
			var discussions = A2(
				_elm_lang$core$List$map,
				function (item) {
			...
			var _p1 = A2(_elm_lang$core$Debug$log, 'Discussion Error: ', _p0._0);
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				_elm_lang$core$Native_List.fromArray(
...
var _user$project$Online_DiscussionMessage$chatterDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Online_Types$Chatter,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'nickname', _elm_lang$core$Json_Decode$string));
var _user$project$Online_DiscussionMessage$extractChatterAsRelatedResource = function (messageResource) {
	var _p0 = A2(_noahzgordon$elm_jsonapi$JsonApi_Resources$relatedResource, 'chatter', messageResource);
	if (_p0.ctor === 'Ok') {
		var _p1 = A2(_noahzgordon$elm_jsonapi$JsonApi_Resources$attributes, _user$project$Online_DiscussionMessage$chatterDecoder, _p0._0);
		if (_p1.ctor === 'Ok') {
			return _p1._0;
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'Online.DiscussionMessage',
				{
...
var _user$project$Online_DiscussionMessage$extractMessageFromResource = function (messageResource) {
	var content = A2(
		_elm_lang$core$Result$withDefault,
		'',
		A2(
			...
			messageResource));
	return {
		chatter: _user$project$Online_DiscussionMessage$extractChatterAsRelatedResource(messageResource),
		content: content
	};
};
var _user$project$Online_DiscussionMessage$extractMessageFromDocument = function (document) {
	var _p4 = _noahzgordon$elm_jsonapi$JsonApi_Documents$primaryResource(document);
	if (_p4.ctor === 'Ok') {
		return _user$project$Online_DiscussionMessage$extractMessageFromResource(_p4._0);
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Online.DiscussionMessage',
			{
				start: {line: 63, column: 5},
				end: {line: 68, column: 30}
			},
			_p4)(_p4._0);
	}
};
var _user$project$Online_DiscussionMessage$extractMessageFromJson = function (raw) {
	var _p6 = A2(_elm_lang$core$Json_Decode$decodeValue, _noahzgordon$elm_jsonapi$JsonApi_Decode$document, raw);
	if (_p6.ctor === 'Ok') {
		return _user$project$Online_DiscussionMessage$extractMessageFromDocument(_p6._0);
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Online.DiscussionMessage',
			{
...
var _user$project$Online_DiscussionMessage$extractMessageCollectionFromDocument = function (document) {
	var _p8 = _noahzgordon$elm_jsonapi$JsonApi_Documents$primaryResourceCollection(document);
	if (_p8.ctor === 'Ok') {
		return A2(_elm_lang$core$List$map, _user$project$Online_DiscussionMessage$extractMessageFromResource, _p8._0);
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Online.DiscussionMessage',
			{
...
var _user$project$Online_DiscussionMessage$extractMessageCollectionFromJson = function (raw) {
	var _p10 = A2(_elm_lang$core$Json_Decode$decodeValue, _noahzgordon$elm_jsonapi$JsonApi_Decode$document, raw);
	if (_p10.ctor === 'Ok') {
		return _user$project$Online_DiscussionMessage$extractMessageCollectionFromDocument(_p10._0);
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Online.DiscussionMessage',
			{
...
var _user$project$Online_DiscussionMessage$receiveOne = F2(
	function (raw, model) {
		var messages = _elm_lang$core$List$reverse(
			A2(
				F2(
					function (x, y) {
						return A2(_elm_lang$core$List_ops['::'], x, y);
					}),
				_user$project$Online_DiscussionMessage$extractMessageFromJson(raw),
				A2(
					_elm_lang$core$List$take,
					model.config.maxMessages - 1,
					_elm_lang$core$List$reverse(model.messages))));
		return _elm_lang$core$Native_Utils.update(
			model,
			{messages: messages});
	});
var _user$project$Online_DiscussionMessage$receiveCollection = F2(
	function (raw, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				messages: _user$project$Online_DiscussionMessage$extractMessageCollectionFromJson(raw)
			});
	});

var _user$project$Online_Update$doShowDiscussion = F2(
	function (discussionId, model) {
		var _p0 = A3(_user$project$Online_Backend$doJoinDiscussionChannel, discussionId, model.config, model.socket);
		var phxSocket = _p0._0;
		var phxCmd = _p0._1;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				...
				{
					socket: phxSocket,
					discussionId: _elm_lang$core$Maybe$Just(discussionId)
				}),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							...
							'#discussions/',
							_elm_lang$core$Basics$toString(discussionId))),
						A2(_elm_lang$core$Platform_Cmd$map, _user$project$Online_Types$PhoenixMsg, phxCmd)
					]))
		};
	});
var _user$project$Online_Update$doShowDiscussionList = function (model) {
	var modifyUrlCmd = _elm_lang$navigation$Navigation$modifyUrl('#discussions');
	var _p1 = model.discussionId;
	if (_p1.ctor === 'Just') {
		var _p2 = A2(_user$project$Online_Backend$leaveDiscussionChannel, _p1._0, model.socket);
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{socket: phxSocket, discussionId: _elm_lang$core$Maybe$Nothing}),
			_1: _elm_lang$core$Platform_Cmd$batch(
				_elm_lang$core$Native_List.fromArray(
					[
						modifyUrlCmd,
...
var _user$project$Online_Update$doRequestDiscussionCreation = F2(
	function (discussion, model) {
		var _p3 = A2(_user$project$Online_Backend$doCreateDiscussion, discussion.subject, model.socket);
		var pxhSocket = _p3._0;
		var phxCmd = _p3._1;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$Online_Update$interpretOutMsg = F2(
	function (outmsg, model) {
		...
		var _p5 = A2(_user$project$Online_Update$doRequestDiscussionCreation, newDiscussion, model);
		var newModel = _p5._0;
		var commands = _p5._1;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				newModel,
				{
					discussions: A2(_elm_lang$core$List_ops['::'], newDiscussion, model.discussions)
				}),
			_1: commands
		};
	});
var _user$project$Online_Update$doInitApplication = function (model) {
	var maybeDiscussionId = function () {
		if (_elm_lang$core$Native_Utils.eq(model.config.discussionId, _elm_lang$core$Maybe$Nothing)) {
			var _p6 = model.route;
			if (_p6.ctor === 'DiscussionRoute') {
				return _elm_lang$core$Maybe$Just(_p6._0);
			} else {
				return _elm_lang$core$Maybe$Nothing;
			}
		} else {
			return model.config.discussionId;
		}
	}();
	var maybeRedirect = function () {
		var _p7 = model.config.discussionId;
		if (_p7.ctor === 'Just') {
	...
	var _p8 = A2(_user$project$Online_Backend$doJoinDiscussionHallChannel, model.config, model.socket);
	var phxSocket = _p8._0;
	var phxCmd = _p8._1;
	var _p9 = function () {
		var _p10 = maybeDiscussionId;
		if (_p10.ctor === 'Just') {
			return A3(_user$project$Online_Backend$doJoinDiscussionChannel, _p10._0, model.config, phxSocket);
		} else {
	...
	return {
		...
		_0: _elm_lang$core$Native_Utils.update(
			model,
			{socket: phxSocket$, discussionId: maybeDiscussionId}),
		_1: _elm_lang$core$Platform_Cmd$batch(
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_elm_lang$core$Platform_Cmd$map, _user$project$Online_Types$PhoenixMsg, phxCmd),
...
var _user$project$Online_Update$update = F2(
	function (msg, model) {
		var _p11 = msg;
		switch (_p11.ctor) {
			case 'NoOp':
			...
			case 'InitApplication':
				return _user$project$Online_Update$doInitApplication(model);
			case 'PhoenixMsg':
				return A2(_user$project$Online_Backend$doHandlePhoenixMsg, _p11._0, model);
			case 'DiscussionEditorMsg':
				return A3(
					_folkertdev$outmessage$OutMessage$evaluateMaybe,
					_user$project$Online_Update$interpretOutMsg,
					_elm_lang$core$Platform_Cmd$none,
					A2(
						_folkertdev$outmessage$OutMessage$mapCmd,
						_user$project$Online_Types$DiscussionEditorMsg,
						A2(
							_folkertdev$outmessage$OutMessage$mapComponent,
							function (discussionEditorModel) {
								return _elm_lang$core$Native_Utils.update(
									model,
									{discussionEditorModel: discussionEditorModel});
							},
							A2(_user$project$Components_DiscussionEditor$update, _p11._0, model.discussionEditorModel))));
			case 'DidJoinChannel':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
			...
			case 'DidLeaveChannel':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'ReceiveAllDiscussions':
				return A2(_user$project$Online_Discussion$receiveAll, _p11._0, model);
			case 'ReceiveMessageList':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Online_DiscussionMessage$receiveCollection, _p11._0, model),
					_1: A3(
						_elm_lang$core$Task$perform,
						_elm_lang$core$Basics$always(_user$project$Online_Types$NoOp),
						_elm_lang$core$Basics$always(_user$project$Online_Types$NoOp),
						_elm_lang$dom$Dom_Scroll$toBottom('main'))
				};
			case 'ReceiveMessage':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Online_DiscussionMessage$receiveOne, _p11._0, model),
					_1: A3(
						_elm_lang$core$Task$perform,
						_elm_lang$core$Basics$always(_user$project$Online_Types$NoOp),
						_elm_lang$core$Basics$always(_user$project$Online_Types$NoOp),
			...
			case 'UpdateCurrentMessage':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{currentMessage: _p11._0}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'SendMessage':
				var discussionId = A2(_elm_lang$core$Maybe$withDefault, 0, model.discussionId);
				var _p12 = A3(_user$project$Online_Backend$doSendMessage, model.currentMessage, discussionId, model.socket);
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{socket: phxSocket, currentMessage: ''}),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_elm_lang$core$Platform_Cmd$map, _user$project$Online_Types$PhoenixMsg, phxCmd)
						]));
			case 'HandlePresenceState':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Online_Presence$processPresenceState, _p11._0, model),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'HandlePresenceDiff':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Online_Presence$processPresenceDiff, _p11._0, model),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'ShowDiscussionList':
				return _user$project$Online_Update$doShowDiscussionList(model);
			default:
				return A2(_user$project$Online_Update$doShowDiscussion, _p11._0, model);
		}
	});

var _user$project$Online_Subscriptions$initApplication = _elm_lang$core$Native_Platform.incomingPort(
	'initApplication',
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}));
var _user$project$Online_Subscriptions$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.socket, _user$project$Online_Types$PhoenixMsg),
				_user$project$Online_Subscriptions$initApplication(
				_elm_lang$core$Basics$always(_user$project$Online_Types$InitApplication))
			]));
};

var _user$project$Online_Views_TopBar$iconView = function (connected) {
	return A2(
		_elm_lang$html$Html$nav,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('navbar-nav text-xs-right col-xs-2')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'fa', _1: true},
								{
								ctor: '_Tuple2',
								_0: 'fa-spinner fa-pulse fa-fw',
								_1: _elm_lang$core$Basics$not(connected)
							},
								{ctor: '_Tuple2', _0: 'fa fa-wifi', _1: connected}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
...
var _user$project$Online_Views_TopBar$titleView = function (title) {
	return A2(
		_elm_lang$html$Html$nav,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('navbar-nav text-xs-center col-xs-7 title-view')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Online_Views_TopBar$onClickPreventDefault = function (msg) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'click',
		_elm_lang$core$Native_Utils.update(
...
var _user$project$Online_Views_TopBar$backView = function (back) {
	var link = function () {
		var _p0 = back;
		if (_p0.ctor === 'Just') {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$class('nav-item nav-link active'),
						_user$project$Online_Views_TopBar$onClickPreventDefault(_p0._0)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('< Leave')
					]));
		} else {
			return A2(
				_elm_lang$html$Html$a,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$href('/sign-out'),
						_elm_lang$html$Html_Attributes$class('nav-item nav-link active')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Exit')
					]));
		}
	}();
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('navbar-nav col-xs-3')
			]),
		_elm_lang$core$Native_List.fromArray(
			[link]));
};
var _user$project$Online_Views_TopBar$view = F2(
	function (model, config) {
		return A2(
			_elm_lang$html$Html$header,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('navbar navbar-fixed-top navbar-dark bg-primary')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Online_Views_TopBar$backView(config.back),
							_user$project$Online_Views_TopBar$titleView(config.title),
							_user$project$Online_Views_TopBar$iconView(model.connected)
						]))
				]));
	});
var _user$project$Online_Views_TopBar$Config = F2(
	function (a, b) {
		return {title: a, back: b};
	});

var _user$project$Online_Views_DiscussionList$participantLine = function (participant) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(participant.nickname)
			]));
};
var _user$project$Online_Views_DiscussionList$discussionCardView = function (discussion) {
	var noParticipants = _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$List$length(discussion.participants),
		0);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						{ctor: '_Tuple2', _0: 'card-warning', _1: noParticipants}
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('card-title text-xs-center')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(discussion.subject)
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('row m-t-2')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('col-xs-5')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[]),
										A2(_elm_lang$core$List$map, _user$project$Online_Views_DiscussionList$participantLine, discussion.participants))
									])),
								A2(
								_elm_lang$html$Html$div,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('col-xs-7')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$type$('button'),
												_elm_lang$html$Html_Attributes$class('btn btn-success btn-block'),
												_elm_lang$html$Html_Events$onClick(
												_user$project$Online_Types$ShowDiscussion(discussion.id))
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('Join Discussion')
											]))
									]))
							]))
					])),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(_elm_lang$core$Basics_ops['++'], 'latest message ', discussion.last_activity))
					]))
			]));
};
var _user$project$Online_Views_DiscussionList$view = function (model) {
	var discussionsView = A2(_elm_lang$core$List$map, _user$project$Online_Views_DiscussionList$discussionCardView, model.discussions);
	var discussionEditorView = A2(
		_elm_lang$html$Html_App$map,
		_user$project$Online_Types$DiscussionEditorMsg,
		_user$project$Components_DiscussionEditor$view(model.discussionEditorModel));
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('container with-fixed-top-navbar')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_user$project$Online_Views_TopBar$view,
				model,
				{title: model.config.nickname, back: _elm_lang$core$Maybe$Nothing}),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('card-columns')
					]),
				A2(_elm_lang$core$List_ops['::'], discussionEditorView, discussionsView))
			]));
};

var _user$project$Online_Views_Discussion$editor = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('navbar navbar-fixed-bottom navbar-light bg-faded')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onSubmit(_user$project$Online_Types$SendMessage)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												{ctor: '_Tuple2', _0: 'padding-right', _1: '0'}
											]))
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$html$Html_Attributes$autofocus(true),
												_elm_lang$html$Html_Events$onInput(_user$project$Online_Types$UpdateCurrentMessage)
											]),
										_elm_lang$core$Native_List.fromArray(
											[]))
									])),
...
var _user$project$Online_Views_Discussion$theirMessage = F2(
	function (nickname, content) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('message theirs pull-xs-left')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													{ctor: '_Tuple2', _0: 'margin-right', _1: '.5rem'}
												]))
										]),
									_elm_lang$core$Native_List.fromArray(
										[
...
var _user$project$Online_Views_Discussion$myMessage = function (content) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('col-xs-10 col-xs-offset-2')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('message mine pull-xs-right')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(content)
...
var _user$project$Online_Views_Discussion$messageView = F2(
	function (chatterId, message) {
		return _elm_lang$core$Native_Utils.eq(message.chatter.id, chatterId) ? _user$project$Online_Views_Discussion$myMessage(message.content) : A2(_user$project$Online_Views_Discussion$theirMessage, message.chatter.nickname, message.content);
	});
var _user$project$Online_Views_Discussion$messageListView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('discussion-messages')
			]),
		A2(
			_elm_lang$core$List$map,
			_user$project$Online_Views_Discussion$messageView(model.config.chatterId),
			model.messages));
};
var _user$project$Online_Views_Discussion$view = F2(
	function (discussion, model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					model,
					{
						...
						back: _elm_lang$core$Maybe$Just(_user$project$Online_Types$ShowDiscussionList)
					}),
					_user$project$Online_Views_Discussion$messageListView(model),
					_user$project$Online_Views_Discussion$editor(model)
				]));
	});

var _user$project$Online_Views_Main$notFoundView = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('NOT FOUND ROUTE')
		]));
var _user$project$Online_Views_Main$loadingView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Online_Views_TopBar$view,
				model,
				{title: 'Loading...', back: _elm_lang$core$Maybe$Nothing})
			]));
};
var _user$project$Online_Views_Main$view = function (model) {
	var _p0 = model.route;
	switch (_p0.ctor) {
		case 'DiscussionListRoute':
			return _user$project$Online_Views_DiscussionList$view(model);
		case 'DiscussionRoute':
			var discussionFromId = A2(
				_elm_community$list_extra$List_Extra$find,
				function (item) {
					return _elm_lang$core$Native_Utils.eq(item.id, _p0._0);
				},
				model.discussions);
			var _p1 = discussionFromId;
			if (_p1.ctor === 'Just') {
				return A2(_user$project$Online_Views_Discussion$view, _p1._0, model);
			} else {
				return _user$project$Online_Views_Main$loadingView(model);
			}
		default:
			return _user$project$Online_Views_Main$notFoundView;
	}
};

var _user$project$Online$urlUpdate = F2(
...
var _user$project$Online$main = {
	main: A2(
		_elm_lang$navigation$Navigation$programWithFlags,
		_user$project$Online_Routing$parser,
		{init: _user$project$Online_Model$init, update: _user$project$Online_Update$update, subscriptions: _user$project$Online_Subscriptions$subscriptions, view: _user$project$Online_Views_Main$view, urlUpdate: _user$project$Online$urlUpdate}),
	flags: A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'chatter_id', _elm_lang$core$Json_Decode$string),
		function (chatter_id) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				A2(_elm_lang$core$Json_Decode_ops[':='], 'max_messages', _elm_lang$core$Json_Decode$string),
				function (max_messages) {
					return A2(
						_elm_lang$core$Json_Decode$andThen,
						A2(_elm_lang$core$Json_Decode_ops[':='], 'maybe_discussion_id', _elm_lang$core$Json_Decode$string),
						function (maybe_discussion_id) {
							return A2(
								_elm_lang$core$Json_Decode$andThen,
								A2(_elm_lang$core$Json_Decode_ops[':='], 'nickname', _elm_lang$core$Json_Decode$string),
								function (nickname) {
									return A2(
										_elm_lang$core$Json_Decode$andThen,
										A2(_elm_lang$core$Json_Decode_ops[':='], 'socket_server', _elm_lang$core$Json_Decode$string),
										function (socket_server) {
											return _elm_lang$core$Json_Decode$succeed(
												{chatter_id: chatter_id, max_messages: max_messages, maybe_discussion_id: maybe_discussion_id, nickname: nickname, socket_server: socket_server});
										});
								});
						});
				});
...
var Elm = {};
Elm['Online'] = Elm['Online'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Online'], 'Online', typeof _user$project$Online$main === 'undefined' ? null : _user$project$Online$main);
